...
Contém todas as atividades desenvolvidas por __[Natalia Ribeiro](https://www.linkedin.com/in/dev-natalia-ribeiro/)__ durante minha trajetória na [Trybe](https://www.betrybe.com/) :rocket:.
...
##### Seção 1: [Unix, Shell e Git](https://github.com/nataliaribeiro-dev/trybe-exercicios/tree/main/fundamentos/secao-01-unix-shell-e-git) :heavy_check_mark:
- [x] 1.1 - Unix & Shell
...
##### Seção 4: [JavaScript: DOM, Eventos e Web Storage](https://github.com/nataliaribeiro-dev/trybe-exercicios/tree/main/fundamentos/secao-04-js-dom-eventos-etc)
...
##### Seção 5: [HTML e CSS: Forms, Flexbox e Responsivo](https://github.com/nataliaribeiro-dev/trybe-exercicios/tree/main/fundamentos/secao-05-hml-css-forms-flexbox-responsivo)
- [ ] 5.1 - HTML & CSS - Forms
...
##### Seção 6: [Introdução à JavaScript ES6 e Testes Unitários](https://github.com/nataliaribeiro-dev/trybe-exercicios/tree/main/fundamentos/secao-06-intro-es6-testes-unit)
- [ ] 6.1 - Fluxo de exceções e manipulação de objetos
- [ ] 6.2 - Primeiros passos em Jest
- [ ] 6.3 - Matchers e cobertura de código
- [ ] 6.4 - Projeto - JavaScript Testes Unitários

##### Seção 7: [Higher Order Functions do JavaScript ES6](https://github.com/nataliaribeiro-dev/trybe-exercicios/tree/main/fundamentos/secao-07-higher-order-functions-es6)
